...
<head>
  ...
  <title>IPS CECEP | Iniciar Sesion</title>
                ...
                <div class="p-5">
                  ...
                  <form class="user" id="login-form" action="" method="post">
                    <div class="form-group">
                      <input type="usuario" class="form-control form-control-user" id="usuario" name="usuario" placeholder="Ingrese Nombre de usuario">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="register.html">Afiliarse a IPS</a>
                  </div>
                </div>
              </div>
            </div>
