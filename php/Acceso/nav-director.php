<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUsuarios3" aria-expanded="true" aria-controls="collapseUsuarios3">
...
<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseServicios3" aria-expanded="true" aria-controls="collapseServicios3">
